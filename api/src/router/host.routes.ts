...
import { deploy, redeploy, getDeployments,deleteDeployment, getBuildsForDeployment, getDeployment, getBuild, getImgForBuild, getWebhookInfo, updateAutoDeploy, updateDeployment, regenerateWebhookSecret } from "../controller/host.controller"
...
hostRouter.patch("/deployment", updateDeployment)
